...
The WebSocket is a **firehose** — once connected, all articles are pushed to you automatically as they arrive. There is no subscription step and no ticker filtering. You receive everything.
